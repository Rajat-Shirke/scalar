...
import OtherEssentials.AESEncryptionDecryption;
...
//        }
        ...
        AESEncryptionDecryption a = new AESEncryptionDecryption();
        String Enc_res = a.encrypt("1234567890");
        String Dec_res = a.decrypt("VQBf+x2ZvkSS+nwufB4WZg==");
        int dummy=Integer.parseInt(Dec_res);
    }
}